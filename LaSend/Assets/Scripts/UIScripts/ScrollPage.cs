...
public class ScrollPage : MonoBehaviour, IBeginDragHandler, IEndDragHandler
{
    ...
    void Update()
    {
        ...
        this.rect.content.GetChild(currentPageIndex).transform.DOScale(1.5f, 0.1f);
    }
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        for (int i = 0; i < this.rect.content.childCount; i++)
        {
            if (this.rect.content.GetChild(i).gameObject.activeSelf)
            {
                this.rect.content.GetChild(i).transform.localScale = new Vector3(1.0f, 1.0f, 1.0f);
            }
        }
